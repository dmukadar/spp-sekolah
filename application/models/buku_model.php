...
*/ 	
	...
	$status=$this->get_status("open");	
	    ...
	    $this->db->where ("ar_invoice.status = '".$status."' and ar_invoice.id_rate=4 or ar_invoice.id_rate=5 or ar_invoice.id_rate=6 or ar_invoice.id_rate=26 or  ar_invoice.id_rate=27 or ar_invoice.id_rate=28 or ar_invoice.id_rate=30 or ar_invoice.id_rate=31  or ar_invoice.id_rate=32 or ar_invoice.id_rate=34 or ar_invoice.id_rate=35 or ar_invoice.id_rate=36");
