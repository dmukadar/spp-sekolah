				...
				<form name="form1" method="post" action="">
				  ...
				  <table width="376" border="0">
                    ...
                    <tr>
                      ...
                      <td><input type="submit" name="Submit2" value="Tambah" onClick=" <?php echo site_url("c_mas02/index");?>"></td>
                    </tr>
                  </table>
				  <label></label>
				</form>
...
<?php 
		...
		?>						<tr>
							...
							<td><div align="center"><a href="<?php echo site_url(" ")."/".$row->id;?>">Ubah</a> <a href="<?php echo site_url(" ")."/".$row->id;?>">Hapus</a> </div></td>
						</tr>
						   <?php }?>
			  </table>
...
<script type="text/javascript">
  ...
  function lookupLocal(){
    ...
    jQuery("#tx_nama").autocomplete(
      "<?php echo site_url("c_mas03/ajax_get_siswa/");?>",
      {
  			delay:5,
  			minChars:2,
  			matchSubset:1,
